...
public class LoginTest {
	...
	public void launchBrowser(String browserName) {
		...
		if (browserName.toLowerCase().equals("chrome")) {
			System.setProperty("webdriver.chrome.driver", "C:\\PROYECTOS AUTOMATIZACION\\MercuryToursAutomationTesting-master\\src\\test\\java\\com\\demoaut\\newtours\\testcases\\chromedriver.exe");
